...
public class ViewUser extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "View User", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Poppins", 0, 14))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       String filmid;
        filmid=jTextField3.getText();
        String sql = "SELECT `Name`, `NIC`, `User ID` FROM `user` WHERE `Username` = "+filmid+"";
        try{
            ...
            String add3=rs.getString("User ID");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try{
     String filmid;
        filmid=jTextField4.getText();
        String sqld = "DELETE FROM `user` WHERE `User ID` = "+filmid+"";   
